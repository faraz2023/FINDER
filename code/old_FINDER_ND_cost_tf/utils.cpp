 ...
 */
  ...
  try {
    __pyx_t_7 = (*__pyx_v_self->inner_Utils).getRobustness(__pyx_v_self->inner_Graph, __pyx_t_8);
  } catch(...) {
    __Pyx_CppExn2PyErr();
...
static PyObject *__pyx_pw_5utils_8py_Utils_5reInsert(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("reInsert (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "reInsert") < 0)) __PYX_ERR(1, 30, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("reInsert", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 30, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  try {
    __pyx_t_10 = (*__pyx_v_self->inner_Utils).reInsert(__pyx_v_self->inner_Graph, __pyx_t_8, __pyx_t_9, __pyx_v_decreaseStrategyID, __pyx_v_reinsertEachStep);
  } catch(...) {
    __Pyx_CppExn2PyErr();
